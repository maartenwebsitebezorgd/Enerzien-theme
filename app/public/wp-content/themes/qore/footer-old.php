            ...
            <div class="container px-4 md:px-10 pt-18 lg:pt-36 pb-10 lg:pb-20 mx-auto target-viewport">
                ...
                <div class="flex justify-between items-center w-full flex-wrap">
                    <div class="font-manrope inline-flex flex-col justify-start items-start lg:max-w-lg mb-16 lg:mb-0">
                        ...
                        <?php if (!empty($link)) { ?>
                            <a class="btn btn-secondary" href="<?php echo $link['url']; ?>" title="<?php echo $link['title']; ?>" target="<?php echo $link['target']; ?>">
                    ...
                    <div class="inline-flex w-full font-manrope flex-col justify-start items-start lg:max-w-xs mb-0 lg:min-w-[370px]">
    ...
    <div class="relative z-2">
            <div class="container md:px-5 lg:pb-9 lg:pt-8 mx-auto flex items-center md:flex-row flex-col target-viewport">
                <nav id="menu-footer" class="flex justify-between items-center w-full flex-wrap text-left">
                    ...
                    <ul class="text-base-content menu items-start inline-flex flex-wrap flex-row text-md lg:text-left mb-10 md:mb-0">
                        <?php wp_nav_menu([
                            'container' => false,
                            'menu_id' => 'menu-footer',
                            'menu_class' => 'menu',
                    ...
                    <ul class="text-base-content menu items-start inline-flex flex-wrap flex-row text-md lg:text-right mb-10 md:mb-0">
                        <li class="menu-item">
                            <span>© <?php echo wp_date('Y').' '.get_bloginfo('name'); ?></span>
                        </li>
                        <li class="menu-item">
                            <span>Webdesign door&nbsp;<a title="Ga naar website van Qore Digital" href="https://qore.digital/?utm_source=<?php echo esc_html(get_site_url()); ?>&utm_medium=footer&utm_campaign=footerlink" target="_blank" class="text-base-content font-bold">Qore Digital</a></span>
                        </li>
                    </ul>
                </nav>
        </div>
