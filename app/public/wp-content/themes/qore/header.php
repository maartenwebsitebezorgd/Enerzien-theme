...
<style>
  html { font-size: calc(0.6250000000000002rem + 0.3124999999999999vw); }
  @media screen and (max-width:1920px) { html { font-size: calc(0.625rem + 0.31250000000000006vw); } }
  @media screen and (max-width:1280px) { html { font-size: calc(0.37500000000000006rem + 0.7812499999999999vw); } }
  @media screen and (max-width:1024px) { html { font-size: calc(0.5rem + 0.7812499999999999vw); } }
