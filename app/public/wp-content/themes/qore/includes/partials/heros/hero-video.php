...
$overlay_opacity = !empty($group['overlay_opacity']) ? $group['overlay_opacity'] : 'opacity-40';
?>

<section class="relative isolate overflow-hidden xl:-mt-20 bg-black">
    <video class="absolute inset-0 -z-10 h-full w-full object-cover <?php echo $group['overlay_opacity']; ?>" autoplay
