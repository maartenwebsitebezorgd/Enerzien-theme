...
<article class="post w-full" data-category="all <?php echo $cat; ?>" role="article">
    <a href="<?php echo get_the_permalink(); ?>" class="block group px-4 md:px-6 pt-4 md:pt-6 pb-6 md:pb-10 relative mb-6 xl:mb-16 last:mb-0 lg:mb-8 lg:last:mb-8 rounded-md bg-transparent hover:bg-white hover:shadow-lg transition-all">

    <?php if (!empty(get_the_post_thumbnail())): ?>
        <span class="bg-base-200 mb-6 w-full flex items-center justify-center flex-col overflow-hidden rounded-md text-white font-bold text-xl h-[213px] transition-all flex-shrink-0">
