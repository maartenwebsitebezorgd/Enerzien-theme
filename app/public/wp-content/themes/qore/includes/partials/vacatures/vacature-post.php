<div
  class="flex gap-6 flex-col md:flex-row p-5 md:p-6 bg-white border border-gray-100 shadow-lg rounded-lg relative transform transition duration-1000 ease-in-out hover:-translate-y-4">
