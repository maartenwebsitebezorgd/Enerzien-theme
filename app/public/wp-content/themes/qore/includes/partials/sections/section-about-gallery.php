    ...
    <div class="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
        <div
            ...
            <div class="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Onze mensen</h2>
                <p class="mt-6 text-xl leading-8 text-gray-600">Wat ons anders maakt? De mensen met wie we dit doen. Een
                    jonge generatie architecten van een slim energie systeem. Aanpakkers met een Energie-technische
                    achtergrond.</p>
                <p class="mt-6 text-base leading-7 text-gray-600">Wij zijn ervaren professionals met een sterke
                    technische basis en een brede interesse. Door ons netwerk van toonaangevende experts en koplopers.
                </p>
            </div>
