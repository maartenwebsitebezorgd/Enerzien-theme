...
<section
    class="<?php echo $padding_top ?>  <?php echo $padding_bottom ?> isolate overflow-hidden bg-white px-6 lg:px-8">
    <div class="container">
            ...
            <figure class="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
                <div class="relative col-span-2 lg:col-start-1 lg:row-start-2">
                    <svg viewBox="0 0 162 128" fill="none" aria-hidden="true"
                        class="absolute -top-12 left-0 -z-10 h-32 stroke-gray-900/20">
                    ...
                    <blockquote class="!m-0 !p-0">
                        <p class="!text-xl/8 !font-semibold !text-gray-900 sm:!text-2xl/9">
                            <?php echo $group['quote']; ?>
                        </p>
                    </blockquote>
                </div>
                ...
                <?php if (!empty($group['name'])): ?>
                    <figcaption class="text-base lg:col-start-1 lg:row-start-3">
                        ...
                        <?php if (!empty($group['function'])): ?>
                            <div class="mt-1 text-gray-500">
                                <?php echo $group['function']; ?>
                            </div>
                        <?php endif; ?>
                    </figcaption>
                <?php endif; ?>
