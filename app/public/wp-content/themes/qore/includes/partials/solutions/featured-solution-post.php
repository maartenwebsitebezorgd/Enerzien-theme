<div
    class="relative isolate flex flex-col justify-end overflow-clip rounded-xl bg-gray-900 px-8 py-6 aspect-[3/4] shadow-lg hover:shadow-sm transition-shadow">
    ...
    <div class="service_body-wrap z-10">
        <div class="service_body-wrap flex flex-col">
            ...
            <p class="opacity-90 text-pretty text-white">
                <?php echo $item['text']; ?>
            </p>
        </div>
    </div>
