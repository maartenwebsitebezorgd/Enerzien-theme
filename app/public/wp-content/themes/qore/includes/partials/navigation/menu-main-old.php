<div id="menu-main" class="w-full flex items-center text-base justify-between pl-4 pr-0 md:pl-10 xl:pr-10 py-4 bg-white z-50">
    ...
    <nav class="inline-flex flex-row flex-wrap items-center justify-start">
        <ul class="list-none inline-flex mb-0 items-center justify-start">
            <li class="hidden xl:flex">
                <a title="Naar blogs" href="<?php echo esc_url(home_url('/blogs/')); ?>" class="btn btn-link text-base-content hover:text-primary">Blog</a>
            </li>
            <li class="hidden sm:flex">
                <a title="Neem contact op" href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn btn-secondary normal-case btn-smhero hero-large body-font relative overflow-hidden">
                    <span class="hidden 2xl:block">Neem contact op</span>
                    <span class="block 2xl:hidden">Contact</span>
                    <?php echo btn_icon('contact'); ?>
                </a>
            </li>
            <li class="flex xl:hidden">
                <button type="button" class="toggle-menu-mobile btn btn-link !text-base-content" aria-pressed="true">
                    <span class="inline-flex justify-start items-center open">
                        <span class="mr-3">Menu</span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
                        </svg>
                    </span>
                    <span class="hidden justify-start items-center close">
...
<nav class="relative border-b border-gray-200 bg-white text-gray-900">
  <div class="container">
    <div class="flex flex-wrap items-center gap-6 py-4">
      <div menu-logo class="flex items-center">
        <a href="<?php echo get_home_url('/'); ?>" class="flex max-w-40 items-center">
          <h3 class="mb-0 text-xl font-semibold text-gray-900">Enerzien</h3>
        </a>
      </div>

      <div menu-items>
        <button dropdown="mega-menu-full" type="button" class="inline-flex h-10 w-10 items-center justify-center rounded-lg p-2 text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 md:hidden" aria-controls="mega-menu-full" aria-expanded="false">
          ...
          <ul class="mb-0 flex flex-col font-medium md:mt-0 md:flex-row rtl:space-x-reverse">
            <li>
              <div class="dropdown static">
                <div tabindex="0" role="button" class="flex w-full items-center justify-between border-b border-gray-100 px-3 py-2 font-bold text-gray-900 hover:bg-gray-50 md:w-auto md:border-0 md:hover:text-emerald-600">
                  Wat we doen
                  <svg class="ms-3 h-2.5 w-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                  </svg>
                </div>
                <div tabindex="0" class="dropdown-content absolute left-0 z-[1] mt-5 w-full border-y border-gray-200 bg-white shadow-sm">
                  <div class="container grid py-5 text-gray-900">
                    <ul aria-labelledby="mega-menu-full-dropdown-content" class="grid grid-cols-2 md:grid-cols-4">
                      <li>
                        <a href="#" class="grid gap-3 rounded-lg p-3 hover:bg-gray-50 md:grid-cols-[max-content_1fr]">
                          ...
                          <div>
                            ...
                            <span class="leading-xtight text-sm text-gray-500 dark:text-gray-400">Met vertrouwen en inzicht investeren in je volgende energie project.</span>
                          </div>
                        </a>
                      </li>
                      <li>
                        <a href="#" class="grid gap-3 rounded-lg p-3 hover:bg-gray-50 md:grid-cols-[max-content_1fr]">
                          ...
                          <div>
                            ...
                            <span class="text-sm text-gray-400">Van ontwerp tot uitvoering, van projectmanagement tot exploitatie.</span>
                          </div>
                        </a>
                      </li>
                      <li>
                        <a href="#" class="grid gap-3 rounded-lg p-3 hover:bg-gray-50 md:grid-cols-[max-content_1fr]">
                          ...
                          <div>
                            ...
                            <span class="text-sm text-gray-500 dark:text-gray-400">Overzicht en duidelijkheid, zodat jij je energiedoelen kunt bereiken.</span>
                          </div>
                        </a>
                      </li>
                      <li>
                        <a href="#" class="grid gap-3 rounded-lg p-3 hover:bg-gray-50 md:grid-cols-[max-content_1fr]">
                          ...
                          <div>
                            ...
                            <span class="text-sm text-gray-500 dark:text-gray-400">Onze adviezen zijn net zo stevig als onze energie technische achtergrond.</span>
                          </div>
                        </a>
                      </li>
                    </ul>
            ...
            <li>
              <a href="#" class="md:hover:bg-gray-5 block border-b border-gray-100 px-3 py-2 font-bold text-gray-900 hover:bg-gray-50 md:border-0 md:hover:text-emerald-700">Toepassingen</a>
            </li>
          </ul>
        </div>
      </div>
      <div menu-actions class="ml-auto flex gap-2">
        <button class="btn btn-outline rounded-full px-6 pb-1 pt-1.5">Werken Bij</button>
        <button class="btn btn-primary rounded-full px-6 pb-1 pt-1.5">Gratis Advies</button>
      </div>
    </div>
  </div>
</nav>
