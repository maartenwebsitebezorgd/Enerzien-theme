    ...
    <div class="flex flex-wrap items-center gap-6">
        <div menu-logo class="flex items-center">
            <a href="<?php echo get_home_url('/'); ?>"
                class="logo flex flex-col leading-tight font-medium items-center text-primary mb-0  max-w-40">
        ...
        <div>
            <button dropdown="mega-menu-full" type="button"
